...
CAABBComponent::CAABBComponent(CActor& owner, const ModelData& model, int priority) :CCollisionComponent(owner, priority)
{
...
CAABBComponent::CAABBComponent(CActor& owner, XMFLOAT3 min, XMFLOAT3 max, int priority) : CCollisionComponent(owner, priority)
{
	mLocalMin = min;
	mLocalMax = max;
}
