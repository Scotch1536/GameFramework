...
public:
	...
	//クォータニオンからオイラー角に変換
	static const XMFLOAT3& TransformFromQuaternionToEulerAngles(const XMFLOAT4& qua, XMFLOAT3& result);
	static XMFLOAT3 TransformFromQuaternionToEulerAngles(const XMFLOAT4& qua);	
	
	//行列からオイラー角に変換
	static const XMFLOAT3& TransformFromMatrixToEulerAngles(const XMFLOAT4X4& matrix, XMFLOAT3& result);
	...
	static const XMFLOAT4X4& UpdateMatrix(const XMFLOAT3& location, const XMFLOAT3& scale, const XMFLOAT4X4& rotMTX, XMFLOAT4X4& result);
	...
	//クオータニオンから行列を算出
	static const XMFLOAT4X4& CalcMatrixFromQuaternion(const XMFLOAT4& target ,XMFLOAT4X4& result);
	...
	//加算
	static const XMFLOAT3& CalcFloat3Addition(const XMFLOAT3& target, const XMFLOAT3& target2, XMFLOAT3& result);
	static XMFLOAT3 CalcFloat3Addition(const XMFLOAT3& target, const XMFLOAT3& target2);

	//減算
	static const XMFLOAT3& CalcFloat3Subtraction(const XMFLOAT3& target , const XMFLOAT3& target2 , XMFLOAT3& result);
	static XMFLOAT3 CalcFloat3Subtraction(const XMFLOAT3& target , const XMFLOAT3& target2);

	//スタートからゴールへのベクトルをゲット
	static const XMFLOAT3& CalcFloat3FromStartToGoal(const XMFLOAT3& start, const XMFLOAT3& goal, XMFLOAT3& result);
